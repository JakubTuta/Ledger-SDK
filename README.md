...
[![Python SDK](https://img.shields.io/badge/python-v1.2.2-blue.svg)](https://pypi.org/project/ledger-sdk/)
...
**Python SDK** (v1.2.2) - [Install from PyPI](https://pypi.org/project/ledger-sdk/)
